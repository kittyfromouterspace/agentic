defmodule AgentEx.Protocol.OpenCode do
  @moduledoc """
  ...
  ## Usage
      ...
      AgentEx.Protocol.Registry.register(:opencode, __MODULE__)

      # Use in a session
      {:ok, session_id} = AgentEx.Protocol.OpenCode.start(config, context)
      {:ok, response} = AgentEx.Protocol.OpenCode.send(session_id, messages, context)
  """
